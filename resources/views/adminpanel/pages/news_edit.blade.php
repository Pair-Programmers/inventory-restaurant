...
<head>
    ...
    <title>AcademyWorld | News Update</title>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        ...
        <div class="ibox-content">
                    <form method="post" class="form-horizontal" action="{{route('admin.news.update', $news->id)}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text"   class="form-control" name="date" value="{{$news->date}}" required>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea name="description" id="" cols="50" rows="5" required >{{$news->description}}</textarea>
                            </div>
