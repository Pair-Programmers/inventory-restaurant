...
<head>
    ...
    <title>AcademyWorld | File Add</title>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="{{route('file.store')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">File/Document</label>

                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            <input type="file" accept="application/pdf" class="form-control" name="document" required> 
                                        </div>
                                    </div>
