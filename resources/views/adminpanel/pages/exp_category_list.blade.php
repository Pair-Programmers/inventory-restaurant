...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        <div class="ibox-content">
            <form method="post" class="form-horizontal" action="{{route('admin.expense.category.store')}}" enctype="multipart/form-data">
                @csrf
                                ...
                                @foreach ($categories as $category)
                                    <tr class="gradeX d-none" id="row-{{$category->id}}">
                                        ...
                                        <td>
                                            ...
                                            <a onclick="deleteExpenseCategory({{$category->id}})">
...
<script>
    ...
    swal({
        ...
        if (isConfirm) {
            $.ajax({
                method: 'GET',
                url: "{{ route('admin.expense.category.destroy', '') }}/" + id,
