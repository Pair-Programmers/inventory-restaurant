...
<head>
    ...
    <title>AcademyWorld | Category Edit</title>
...
<body>
    ...
    <?=$sidebar; ?>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="{{route('category.update', $category->id)}}" enctype="multipart/form-data">
                                @csrf
        ...
        <div class="footer">
            ...
            <div>
                <strong>Copyright</strong> AcademyWorld &copy; 2021
            </div>
        </div>
