...
<head>
    ...
    <title>AcademyWorld | File Edit</title>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="{{route('file.update', $file->id)}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <textarea name="description" id="" cols="50" rows="5">{{$file->description}}</textarea>
                                    </div>
